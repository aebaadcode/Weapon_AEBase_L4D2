datablock AudioProfile(L4D2_AK47FireSound)
{
   filename    = "./Sounds/Fire/AK47_fire.wav";
...
// item //
//////////
datablock ItemData(L4D2_AK47Item)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./AK47/Ak47PU.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "L4D2: AK47";
	iconName = "./Icons/UI_AK47";
	doColorShift = true;
	colorShiftColor = "0.4 0.4 0.41 1.000";

	 // Dynamic properties defined by the scripts
	image = L4D2_AK47Image;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(L4D2_AK47Image)
{
   // Basic Item properties
   ...
   //raise your arm up or not
	armReady = true;
	hideHands = true;
	safetyImage = L4D2_AK47SafetyImage;
 //   scopingImage = L4D2_AK47IronsightImage;
	doColorShift = true;
	colorShiftColor = L4D2_AK47Item.colorShiftColor;//"0.400 0.196 0 1.000";
   ...
   // Initial start up state
	...
	stateSound[0]				= L4D2_AK47EquipSound;
	stateSequence[0]			= "use";
	...
	stateSound[6]				= L4D2_AK47ClipOutSound;
	
	stateName[7]				= "ReloadB";
	stateTimeoutValue[7]			= 1.4;
	stateTransitionOnTimeout[7]		= "Reloaded";
	stateWaitForTimeout[7]			= true;
	stateSequence[7]			= "reload2";
	stateSound[7]				= L4D2_AK47ClipInSound;
...
function L4D2_AK47Image::AEOnFire(%this,%obj,%slot)
{	
	%obj.stopAudio(3); 
    %obj.playAudio(3, L4D2_AK47FireSound);
...
function L4D2_AK47Image::AEOnLowClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(0, plant);
}

function L4D2_AK47Image::AEOnMedClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(3, jump);
   %obj.aeplayThread(0, plant);
}

function L4D2_AK47Image::AEOnHighClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(3, jump);
}

function L4D2_AK47Image::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}

function L4D2_AK47Image::onReady(%this,%obj,%slot)
{
...
function L4D2_AK47Image::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function L4D2_AK47Image::onUnMount(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(L4D2_AK47SafetyImage)
{
   shapeFile = "./AK47/AK47.dts";
   emap = true;
   mountPoint = 0;
   ...
   armReady = false;
   hideHands = true;
   scopingImage = L4D2_AK47Image;
   safetyImage = L4D2_AK47Image;
   doColorShift = true;
   colorShiftColor = L4D2_AK47Item.colorShiftColor;
...
function L4D2_AK47SafetyImage::onDone(%this,%obj,%slot)
{
	%obj.mountImage(%this.safetyImage, 0);
}

function L4D2_AK47SafetyImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
	cancel(%obj.reload3Schedule);
	cancel(%obj.reload4Schedule);
...
function L4D2_AK47SafetyImage::onUnMount(%this, %obj, %slot)
{
	%this.AEUnmountCleanup(%obj, %slot);
	parent::onUnMount(%this,%obj,%slot);
}
...
function L4D2_AK47IronsightImage::onMount(%this,%obj,%slot)
{
	%obj.aeplayThread(2, plant);
...
function L4D2_AK47IronsightImage::onUnMount(%this,%obj,%slot)
{
	if(isObject(%obj.client) && %obj.client.IsA("GameConnection"))
