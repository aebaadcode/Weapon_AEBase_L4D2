datablock AudioProfile(L4D2_ChromeShotgunFireSound)
{
   filename    = "./Sounds/Fire/Chrome_Shotgun_Fire.wav";
...
// item //
//////////
datablock ItemData(L4D2_ChromeShotgunItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./ChromeShotgun/ChromeShotgunPU.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "L4D2: Chrome Shotgun";
	iconName = "./Icons/UI_CShotgun";
	doColorShift = true;
	colorShiftColor = "0.3 0.3 0.31 1.000";

	 // Dynamic properties defined by the scripts
	image = L4D2_ChromeShotgunImage;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(L4D2_ChromeShotgunImage)
{
   // Basic Item properties
   shapeFile = "./ChromeShotgun/ChromeShotgun.dts";
   emap = true;
   ...
   armReady = true;
   hideHands = true;
   safetyImage = L4D2_ChromeShotgunSafetyImage;
   doColorShift = true;
   colorShiftColor = L4D2_ChromeShotgunItem.colorShiftColor;
...
//   shellSoundMax = 550; //max delay for when the shell sound plays
   ...
   // Initial start up state
	...
	stateSound[0]			  	= L4D2_HuntingShotgunUseSound;
...
//	stateTransitionOnNoAmmo[2]       	= "FireEmpty";
	...
	stateSound[4]			  	= L4D2_HuntingShotgunReloadSound;
	...
	stateSound[10]				= L4D2_HuntingShotgunShellInSound;
	...
	stateSound[13]				= L4D2_HuntingShotgunShellInSound;
	...
	stateTimeoutValue[17]		  	= 0.7;
	stateSequence[17]			= "Pump";
	stateSound[17]			  	= L4D2_HuntingShotgunReloadSound;
...
function L4D2_ChromeShotgunImage::AEOnFire(%this,%obj,%slot)
{
	%obj.blockImageDismount = true;
	%obj.schedule(900, unBlockImageDismount);

	cancel(%obj.reloadSoundSchedule);
	cancel(%obj.insertshellSchedule);
	%obj.stopAudio(0); 
	%obj.playAudio(0, L4D2_ChromeShotgunFireSound);	

	Parent::AEOnFire(%this, %obj, %slot);
}

function L4D2_ChromeShotgunImage::AEOnLowClimb(%this, %obj, %slot) 
{
	%obj.playThread(2, activate);
}

function L4D2_ChromeShotgunImage::onReloadEnd(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function L4D2_ChromeShotgunImage::onReload2End(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function L4D2_ChromeShotgunImage::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}

function L4D2_ChromeShotgunImage::onReady(%this,%obj,%slot)
{
...
function L4D2_ChromeShotgunImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
	parent::onMount(%this,%obj,%slot);
}

function L4D2_ChromeShotgunImage::onUnMount(%this, %obj, %slot)
{	
...
function L4D2_ChromeShotgunImage::LoadEffect(%this,%obj,%slot)
{
    %obj.insertshellSchedule = %this.schedule(200,AEShotgunLoadOne,%obj,%slot);
}

function L4D2_ChromeShotgunImage::AEShotgunLoadOneEffectless(%this,%obj,%slot)
{
	Parent::AEShotgunLoadOne(%this, %obj, %slot);
}

function L4D2_ChromeShotgunImage::onPump(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(L4D2_ChromeShotgunSafetyImage)
{
   shapeFile = "./ChromeShotgun/ChromeShotgun.dts";
   emap = true;
   mountPoint = 0;
   offset = "0.05 -0.325 -0.2";
   eyeOffset = "0 0 0";
   ...
   armReady = false;
   hideHands = true;
   scopingImage = L4D2_ChromeShotgunImage;
   safetyImage = L4D2_ChromeShotgunImage;
   doColorShift = true;
   colorShiftColor = L4D2_ChromeShotgunItem.colorShiftColor;
...
function L4D2_ChromeShotgunSafetyImage::onDone(%this,%obj,%slot)
{
	%obj.mountImage(%this.safetyImage, 0);
}

function L4D2_ChromeShotgunSafetyImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
...
function L4D2_ChromeShotgunSafetyImage::onUnMount(%this, %obj, %slot)
{
	%this.AEUnmountCleanup(%obj, %slot);
	parent::onUnMount(%this,%obj,%slot);
}
