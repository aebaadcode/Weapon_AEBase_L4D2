datablock AudioProfile(L4D2_HuntShotgunFireSound)
{
   filename    = "./Sounds/Fire/Hunting_Shotgun_Fire.wav";
...
// item //
//////////
datablock ItemData(L4D2_HuntShotgunItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./Huntshotgun/HuntshotgunPU.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "L4D2: Hunting Shotgun";
	iconName = "./Icons/UI_HShotgun";
	doColorShift = true;
	colorShiftColor = "0.3 0.3 0.31 1.000";

	 // Dynamic properties defined by the scripts
	image = L4D2_HuntShotgunImage;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(L4D2_HuntShotgunImage)
{
   // Basic Item properties
   shapeFile = "./Huntshotgun/Huntshotgun.dts";
   emap = true;
   ...
   armReady = true;
   hideHands = true;
   safetyImage = L4D2_HuntShotgunSafetyImage;
   doColorShift = true;
   colorShiftColor = L4D2_HuntShotgunItem.colorShiftColor;
...
//	stateTransitionOnNoAmmo[2]       	= "FireEmpty";
	...
	stateTimeoutValue[17]		  	= 0.78;
	stateSequence[17]			= "Cocker";
...
function L4D2_HuntShotgunImage::AEOnFire(%this,%obj,%slot)
{
	...
	%obj.stopAudio(0); 
	%obj.playAudio(0, L4D2_HuntShotgunFireSound);	

	Parent::AEOnFire(%this, %obj, %slot);
}

function L4D2_HuntShotgunImage::AEOnLowClimb(%this, %obj, %slot) 
{
	%obj.playThread(2, activate);
}

function L4D2_HuntShotgunImage::onReloadEnd(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function L4D2_HuntShotgunImage::onReload2End(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function L4D2_HuntShotgunImage::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}

function L4D2_HuntShotgunImage::onReady(%this,%obj,%slot)
{
...
function L4D2_HuntShotgunImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
	parent::onMount(%this,%obj,%slot);
}

function L4D2_HuntShotgunImage::onUnMount(%this, %obj, %slot)
{	
...
function L4D2_HuntShotgunImage::LoadEffect(%this,%obj,%slot)
{
    %obj.insertshellSchedule = %this.schedule(200,AEShotgunLoadOne,%obj,%slot);
}

function L4D2_HuntShotgunImage::AEShotgunLoadOneEffectless(%this,%obj,%slot)
{
	Parent::AEShotgunLoadOne(%this, %obj, %slot);
}

function L4D2_HuntShotgunImage::onPump(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(L4D2_HuntShotgunSafetyImage)
{
   shapeFile = "./Huntshotgun/Huntshotgun.dts";
   emap = true;
   mountPoint = 0;
   ...
   armReady = false;
   hideHands = true;
   scopingImage = L4D2_HuntShotgunImage;
   safetyImage = L4D2_HuntShotgunImage;
   doColorShift = true;
   colorShiftColor = L4D2_HuntShotgunItem.colorShiftColor;
...
function L4D2_HuntShotgunSafetyImage::onDone(%this,%obj,%slot)
{
	%obj.mountImage(%this.safetyImage, 0);
}

function L4D2_HuntShotgunSafetyImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
...
function L4D2_HuntShotgunSafetyImage::onUnMount(%this, %obj, %slot)
{
	%this.AEUnmountCleanup(%obj, %slot);
	parent::onUnMount(%this,%obj,%slot);
}
