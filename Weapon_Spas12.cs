datablock AudioProfile(L4D2_Spas12fireSound)
{
   filename    = "./Sounds/Fire/SPAS12_fire.wav";
...
// item //
//////////
datablock ItemData(L4D2_Spas12Item)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./Spas12/Spas12PU.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	//gui stuff
	uiName = "L4D2: SPAS-12";
	iconName = "./Icons/UI_Spas12";
	doColorShift = true;
	colorShiftColor = "0.5 0.5 0.51 1.000";

	 // Dynamic properties defined by the scripts
	image = L4D2_Spas12Image;
	canDrop = true;
...
//weapon image//
////////////////
datablock ShapeBaseImageData(L4D2_Spas12Image)
{
   // Basic Item properties
   ...
   armReady = true;
   hideHands = true;
   safetyImage = L4D2_Spas12SafetyImage;
   doColorShift = true;
   colorShiftColor = L4D2_Spas12Item.colorShiftColor;
   ...
   // Initial start up state
	...
	stateSound[0]			  	= L4D2_SPAS12EquipSound;
...
//	stateTransitionOnNoAmmo[2]       	= "FireEmpty";
	...
	stateSound[10]				= L4D2_Spas12LoadShellSound;
	...
	stateSound[13]				= L4D2_Spas12LoadShellSound;
	...
	stateSequence[17]			= "pullback";
	stateSound[17]			  	= L4D2_SPAS12PumpSound;
...
function L4D2_Spas12Image::AEOnFire(%this,%obj,%slot)
{
	...
	%obj.stopAudio(0); 
	%obj.playAudio(0, L4D2_Spas12FireSound);	

	Parent::AEOnFire(%this, %obj, %slot);
}

function L4D2_Spas12Image::AEOnLowClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(0, activate);
}

function L4D2_Spas12Image::AEOnMedClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(0, activate);
}

function L4D2_Spas12Image::AEOnHighClimb(%this, %obj, %slot) 
{
   %obj.aeplayThread(0, activate);
}

function L4D2_Spas12Image::onReloadEnd(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function L4D2_Spas12Image::onReload2End(%this,%obj,%slot)
{
	Parent::AEMagReloadAll(%this, %obj, %slot);
}

function L4D2_Spas12Image::onDryFire(%this, %obj, %slot)
{
	%obj.aeplayThread(2, plant);
	serverPlay3D(AEDryFireSound, %obj.getHackPosition());
}

function L4D2_Spas12Image::onReady(%this,%obj,%slot)
{
...
function L4D2_Spas12Image::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
	parent::onMount(%this,%obj,%slot);
}

function L4D2_Spas12Image::onUnMount(%this, %obj, %slot)
{	
...
function L4D2_Spas12Image::LoadEffect(%this,%obj,%slot)
{
    %obj.insertshellSchedule = %this.schedule(200,AEShotgunLoadOne,%obj,%slot);
}

function L4D2_Spas12Image::AEShotgunLoadOneEffectless(%this,%obj,%slot)
{
	Parent::AEShotgunLoadOne(%this, %obj, %slot);
}

function L4D2_Spas12Image::onPump(%this,%obj,%slot)
{
...
datablock ShapeBaseImageData(L4D2_Spas12SafetyImage)
{
   shapeFile = "./Spas12/Spas12.dts";
   emap = true;
   mountPoint = 0;
   ...
   armReady = false;
   hideHands = true;
   scopingImage = L4D2_Spas12Image;
   safetyImage = L4D2_Spas12Image;
   doColorShift = true;
   colorShiftColor = L4D2_Spas12Item.colorShiftColor;
...
function L4D2_Spas12SafetyImage::onDone(%this,%obj,%slot)
{
	%obj.mountImage(%this.safetyImage, 0);
}

function L4D2_Spas12SafetyImage::onMount(%this,%obj,%slot)
{
	%this.AEMountSetup(%obj, %slot);
...
function L4D2_Spas12SafetyImage::onUnMount(%this, %obj, %slot)
{
	%this.AEUnmountCleanup(%obj, %slot);
	parent::onUnMount(%this,%obj,%slot);
}
