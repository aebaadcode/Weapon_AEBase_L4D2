...
{
   filename    = "./Mac10_Fire.wav";
   description = AudioClose3d;
   preload = true;
};

//OtherData
AddDamageType("Mac10",   '<bitmap:add-ons/Weapon_SMGS/ci_Mac10> %1',    '%2 <bitmap:add-ons/Weapon_SMGS/ci_Mac10> %1',0.75,1);
datablock ProjectileData(Mac10Projectile)
{
   projectileShapeName = "add-ons/Weapon_Gun/bullet.dts";
   directDamage        = 10;
   directDamageType    = $DamageType::Mac10;
   radiusDamageType    = $DamageType::Mac10;
...
function Mac10Image::onLoadCheck(%this,%obj,%slot)
{
...
function Mac10Image::onReloaded(%this,%obj,%slot)
{
